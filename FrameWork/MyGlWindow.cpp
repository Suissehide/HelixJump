...
static double DEFAULT_VIEW_POINT[3] = {90, 90, 90};
...
//==========================================================================
{
	...
	cylinder = Cylinder(3.0f ,3.0f, 50.0f, 36.0f, 1, true);

	platforme = Cylinder(cylinder.getBaseRadius()*2.5, cylinder.getBaseRadius() * 2.5, cylinder.getBaseRadius()/2, 36.0f, 1, true);
	hole = Cylinder(cylinder.getBaseRadius()*2.5, cylinder.getBaseRadius() * 2.5, cylinder.getBaseRadius()/2, 3.0f, 1, true);
